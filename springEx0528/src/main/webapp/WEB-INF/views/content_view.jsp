		...
		<section>
			<div id="content">
				<div>
					...
					<!--  버튼 -->
					<div>
						<a href="reply_view?BId=${dto.BId }" role="button">답글달기</a>
						<a href="modify_view?BId=${dto.BId }" role="button">수정</a>
						<input type="button" value="삭제" onclick="delete_check(${dto.BId })">
<%-- 		<a href="delete.do?bId=${dto.BId }" role="button">삭제</a> --%>
						<!-- 무조건 1페이지로 이동.. -->
